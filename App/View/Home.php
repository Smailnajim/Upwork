...
<html lang="en">
   <head>
      ...
      <!-- bootstrap css -->
      <link rel="stylesheet" href="./../hightech-html/css/bootstrap.min.css">
      <!-- style css -->
      <link rel="stylesheet" href="./../hightech-html/css/style.css">
      <!-- responsive-->
      <link rel="stylesheet" href="./../hightech-html/css/responsive.css">
      <!-- awesome fontfamily -->
   ...
   <body class="main-layout">
      ...
      <!-- end footer -->
      <!-- Javascript files-->
      <script src="./../hightech-html/js/jquery.min.js"></script>
      <script src="./../hightech-html/js/bootstrap.bundle.min.js"></script>
      <script src="./../hightech-html/js/jquery-3.0.0.min.js"></script>
      <script src="./../hightech-html/js/custom.js"></script>
   </body>
</html>